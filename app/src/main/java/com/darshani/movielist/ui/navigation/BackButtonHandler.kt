...
private class ComposebleBackNavigationHandler(enabled: Boolean): OnBackPressedCallback(enabled) {
...
internal fun ComposableHandler(
    ...
    val handler = remember { ComposebleBackNavigationHandler(enabled)}
